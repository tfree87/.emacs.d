...
#+date: Time-stamp: <2021-10-23 14:25:11 thomas>
...
* Track Load Time
  ...
  #+end_src
* Basic Configuration
This section contains modifications for Emacs that affect the behavior in nearly all buffer.
** User Interface
...
Dired+ allows for better functionality when using Emacs in Windows.
#+begin_src emacs-lisp :tangle yes
  (use-package dired+
...
#+end_src
** ~org-mind-map~
Turn any ~org-mode~ buffer into a mind map.
#+begin_src emacs-lisp :tangle yes
...
#+end_src
** ~org-ref~
*** Install and Initialize Org-ref
#+begin_src emacs-lisp :tangle yes
  (use-package org-ref
    :ensure t
    :defer t
