...
#+date: Time-stamp: <2024-11-02 20:59:03 thomas>
#+language: en_US
...
#+begin_src emacs-lisp :comments both :noweb-ref org_customize
...
#+begin_src emacs-lisp :comments both :noweb-ref org_contrib_config
  (require 'ox-extra)
...
#+begin_src emacs-lisp :comments both :noweb-ref org_config
...
#+begin_src emacs-lisp :comments both :tangle yes
