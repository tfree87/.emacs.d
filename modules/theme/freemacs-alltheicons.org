...
#+date: Time-stamp: <2022-07-07 20:51:57 thomas>
#+language: en_US
...
Setup All the Icons Completion for Marginalia mode if Marginalia Mode is active.

#+begin_src emacs-lisp :noweb-ref ati_completion_config
